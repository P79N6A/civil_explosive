...
define(function(require,exports,module){
	...
	var createSipIdUrl = "scene/scenecamera/createId.do";
	...
	function createToolbar(gridOpts){
		...
		gridOpts.toolbarEx = [{
			...
			onClick:function(){
				$ui.postEx(createSipIdUrl,function(retJson){
					var row = {};
					row.sipId = retJson.data;
					row.platType = 1;
			...
			onClick:function(){
				$ui.postEx("scene/scenecamera/regAll.do");
			}
		}];
	}
	//创建列
	function createColumns(gridOpts){
		...
		gridOpts.columns = [[
			...
			{field:'unitName',title:'所属从业单位',width:100,editor:{
				required:true,
				eName:'combobox',
				name:'unitId',
				editable:false,
			...
			{field:'sipId',title:'设备id',width:160,editor:{required:true}},
			{field:'cameraCount',title:'摄像头数量',editor:{},width:160},
			...
			{field:'rtmpdCtx',title:'rtmpd上下文',editor:{
				...
				queryParams:{'codeType':'k','codeDesc4':2}
			}},
